...
public class CommandTestUtil {
    ...
    public static final String VALID_ROLE_AMY = "UI Designer";
    public static final String VALID_ROLE_BOB = "Head of Office";
    public static final String VALID_TAG_HUSBAND = "husband";
    public static final String VALID_TAG_FRIEND = "friend";

    public static final String NAME_DESC_AMY = " " + VALID_NAME_AMY; // Removed PREFIX_NAME
    public static final String NAME_DESC_BOB = " " + VALID_NAME_BOB; // Removed PREFIX_NAME
    ...
    public static void showPersonAtIndex(Model model, Index targetIndex) {
        ...
        model.updateFilteredPersonList(new PersonMatchesKeywordPredicate(Arrays.asList(splitName[0])));
