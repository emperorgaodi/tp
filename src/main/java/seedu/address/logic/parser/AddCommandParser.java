    ...
    public AddCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL,
                        PREFIX_ROLE, PREFIX_DEPARTMENT, PREFIX_TAG);

        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_ROLE, PREFIX_DEPARTMENT, PREFIX_PHONE, PREFIX_EMAIL)
        ...
        Person person = new Person(name, phone, email, role, department, tagList);
